class phones {
  ...
  phones(
      ...
      required this.HalfOnRemote,
      required this.id,
      required this.TypeMicro});
  ...
  @override
  String toString() {
    return 'phones{id:$id phone:$phone AlarmTime:$AlarmTime,CallOnElectricity:$CallOnElectricity,Contacts:$Contacts;,Language:$Language,MoodAlarm:$MoodAlarm,Name:$Name,OnPhones:$OnPhones,OpratorSim:$OpratorSim,Password:$Password,PeriodicBatteryReport:$PeriodicBatteryReport,PeriodicInventoryReport:$PeriodicInventoryReport,Relleh:$Relleh,Zone:$Zone,Anten: $Anten,Charge :$Charge,CountConuntect: $CountConuntect,Countremote:$Countremote,Speaker: $Speaker,StatusNetwork:$StatusNetwork,StatusRelleh:$StatusRelleh,VoltAc:$VoltAc,Voltbatry:$Voltbatry,contacts1:$contacts1,contacts2:$contacts2,contacts3:$contacts3,contacts4:$contacts4,contacts5:$contacts5,contacts6:$contacts6,contacts7:$contacts7,contacts8:$contacts8,contacts9:$contacts9,contacts10:$contacts10,HalfOnRemote:$HalfOnRemote,TypeMicro:$TypeMicro}';
  }
}
